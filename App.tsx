          ...
          <div className={`p-5 rounded-[2rem] flex flex-col gap-4 shadow-2xl animate-in slide-in-from-top bg-gradient-to-br ${alertStyles} text-white relative overflow-hidden`}>
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] font-bold opacity-80 flex items-start gap-1 leading-relaxed mt-1">
                  <PhoneCall size={12} className="mt-0.5 flex-shrink-0" /> Pour recevoir votre code d'activation (1 mois, 3 mois, 6 mois, 12 mois), appelez sur Whatsapp 99 606 484 ou 55 897 000.
                </p>
              </div>
            </div>
